    ...
    public static List<Jeans> getAllJeans() {
        ...
        class Levis extends AbstractJeans{
            ...
            public String toString() {
                ...
                return this.getClass().getSimpleName()+"{id="+this.id+", length="+this.length+", size="+this.size+", price="+this.price+"}";
            }
        }
        ...
        for (Object[] obj : getJeansArray()) {
            ...
            if (Company.Levis == company) {
                ...
                jeans = new AbstractJeans(id, length, size, price) {
                    ...
                    @Override
                    public String toString() {
                        return this.getTM()+"{id="+this.id+", length="+this.length+", size="+this.size+", price="+this.price+"}";
                    }
                };
            }
            allJeans.add(jeans);
